...
if __name__ == "__main__":
    ...
    g6.unique_id(max_age=90, min_hits=1, iou_threshold=0.05, save_load = "load")
    ...
    s7.unique_id(max_age=90, min_hits=1, iou_threshold=0.05, save_load = "load")
    ...
    joined = cyclist.Camera("joined", "joined")
    joined.tracker_df = join_df([g6.tracker_df, s7.tracker_df])
    joined.new_bbox(10)
    joined.df_format()
    joined.unique_id(max_age=90, min_hits=1, iou_threshold=0.05, save_load = "new")
    ...
    joined.tracker_df.to_csv("CSV/joined_df_corrected_90_1_0.05_bbox10.csv")