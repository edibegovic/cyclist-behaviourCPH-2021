...
def run_all(tracker_df, range_n_clusters=[4,5,6,7,8,9,10]): 
...
if __name__ == "__main__":
    ...
    sum(g6.tracker_df.groupby("unique_id")["unique_id"].nunique())
    ...
    grouped = tr.groupby("unique_id")

    count_unique_id = sum(grouped["unique_id"].nunique())
    count_unique_id
