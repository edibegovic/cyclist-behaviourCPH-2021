...
The Dybbølsbro intersection in Copenhagen was chosen as it faces several traffic flow challanges as a result development in the immediate vacinity, it is a large intersection and has alot of signage.
These challanges make the Dybbølsbro intersection one of the more extreme in Copenhagen for this research. 

To determine the desire paths that cyclist take throught the Dybbelsbro intersection we recorded digital video footage 
of the Dybbølsbro interstction from three different camera angles.
...
The unique ID is accompanied by an x and y coordinate of the detected cyclist on the frame. The (x, y) coordinates over multiple frames represents the track a cyclist takes over the intersection.
