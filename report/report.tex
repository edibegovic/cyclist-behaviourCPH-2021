...
collection are reliant on the human annotation of video recordings, which is expensive, time-consuming,
...
video syncing, camera calibration, object detection, projection, merging of different 
