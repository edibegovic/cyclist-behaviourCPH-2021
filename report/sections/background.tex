...
It is therefore important to carefully plan new cycling infrastructure and rapidly adapt to the observed behavior of new users.
...
The proportions of cyclists belonging to each of the above groups were then compared over the span of a day. 
...
branching lines, they wouldn't be included in the desire line count.
\ \\

We discuss the findings derived from OpenDataCam in our own case study in later sections of the report.