...
Given eq. \ref{eqn:eq1}, we can calculate the contact points using the objects bounding box coordinates.
...
This is achieved by multiplying each cyclist contact point with the homography matrix, this returns the 
...
we used a $10 \times 10$ pixel bounding box. Using arbitrary bounding boxes is a result of the plane of 
