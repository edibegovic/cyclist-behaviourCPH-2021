To quantify the effectiveness of our method, we compared various metrics from manually annotated data. Manually annotated data acting as the ground truth. 
